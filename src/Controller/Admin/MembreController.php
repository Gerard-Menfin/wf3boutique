...
{
    /**
     * @Route("/{page?}", name="admin_membre_index", methods={"GET"}, requirements={"page"="\d+"})
     */
    public function index($page, MembreRepository $membreRepository, PaginatorInterface $paginator, Request $rq): Response
    {
        $page = $page ?? 1;
        return $this->render('admin/membre/index.html.twig', [
            'membres' => $paginator->paginate($membreRepository->findAll(), $page, 1)
        ]);
    }
    ...
    /**
     * @Route("/fiche/{id}", name="admin_membre_show", methods={"GET"})
     */
