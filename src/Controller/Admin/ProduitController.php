...
class ProduitController extends AbstractController
{
    ...
    /**
     * @Route("/liste", name="admin_produit_index_ajax", methods={"GET"})
     */
    ...
    /**
     * Si on ajoute ? après le nom d'un paramètre de la route, le paramètre devient optionnel
     * 
     * @Route("/{page?}", name="admin_produit_pagination", methods={"GET"}, requirements={"page"="\d+"})
     */
    #[Route("/{page<\d+>?}",  name:"admin_produit_pagination")]
